                ...
                <main>
                    ...
                    <h1 class="mt-4">Routers</h1>
                        ...
                        <form action="routers.php" method="POST">
                          ...
                          <div class="col md 6">
                          <button type="submit" class="btn btn-primary" name="filt_rout">Filtrar</button>
                          </div>
                    ...
                    <table class="table text-center " >
                        ...
                        <tbody>
                        <?php 
                        if (isset($_POST['filt_rout'])){
                        extract($_POST);
                        echo $sel_estado;
                        Conexion::abrir_conexion();
                        Selects::escribir_routers(Conexion::obtener_conexion(),$sel_estado);
