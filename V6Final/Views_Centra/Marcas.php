...
<html lang="en">
  ...
  <body>
    ...
    <div id="layoutSidenav_content">
                ...
                Selects::escribir_marcas_rad(Conexion::obtener_conexion());
                Conexion::cerrar_conexion();
                        ...
                        <?php 
                          Conexion::abrir_conexion();
                          Selects::escribir_marcas_rou(Conexion::obtener_conexion());
                          Conexion::cerrar_conexion();
                        ?>
                        </tbody>
                    </table>
        ...
        <?php include 'modals_central.php'; ?>
