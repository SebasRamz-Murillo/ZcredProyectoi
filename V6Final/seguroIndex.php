          ...
          <?php  
                    if(isset($_POST['add_cliente'])){
                      ...
                      try {
                        ...
                        $ins_cliente= "INSERT INTO clientes(usuario_cliente, estado_cliente, no_casa, referencias, rancho_cliente, calle_uno, calle_dos) VALUES ($result[id_usuario],2,'$no_casa','$refer','$sel_rancho','$calleuno','$calledos')";
                        $conexion->query($ins_cliente);
                      ?>
                      <div class="alert alert-success" role="alert">
                      Bienvendio por favor vuelva inicie sesion!
                      </div>
                      <?php
    ...
    <div class="mx-auto text-center ">
        <form>
            <div class="mb-3">
              ...
              <input type="email" class="form-control text-center fs-4 input-group-lg" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Escribe tu codigo postal">
            </div>          
            <button type="submit" class="btn btn-primary btn-lg">Buscar cobertura</button>
          </form>
    </div>
</div>
      ...
      <div class="row g-0">
        ...
        <div class="col-md-8">
          <div class="card-body text-center">
            ...
            <p class="card-text Letra"> La proveedora “Zacred” es una proveedora de servicios de internet ubicada en Zacatecas en las localidades de 
        Juan Aldama y Miguel Auza, sus inicios remontan a la llegada del covid, ya que el aumento del ancho de banda 
        necesario para las casas aumento y las localidades no contaban con la infrestructura necesaria para demanda 
        de internet que el se empezo a necesitar por las necesidades de las familias, se establecieron </p>
          </div>
        </div>
      </div>
    </div>
...
<nav class="navbar navbar-dark bg-dark">
  <div class="contenido-contacto">
   ...
   <!---------------Información de contacto----------->
        ...
        <div class="modal fade" id="contraOlvi" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2" tabindex="-1">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalToggleLabel2">Restauración de contraseña</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        Poner cosas de restauracion de contra aqui saludos bai
                    </div>
                    <div class="modal-footer">
                        <button class="btn btn-primary" data-bs-target="#inicioSesion" data-bs-toggle="modal">Regresar a inicio de sesión</button>
                    </div>
                </div>
            </div>
        </div>
